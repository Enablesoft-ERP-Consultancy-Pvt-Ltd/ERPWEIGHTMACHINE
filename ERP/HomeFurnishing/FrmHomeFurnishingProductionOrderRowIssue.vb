...
Public Class FrmHomeFurnishingProductionOrderRowIssue
    ...
    Private Sub FrmDepartmentRowIssue_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        " From HomeFurnishingOrderMaster HFMO(Nolock)  " & _
    ...
    Private Sub DDprocess_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles DDprocess.SelectedIndexChanged
        If DDprocess.SelectedIndex <> -1 And Varcombovalue <> 0 Then
            hnprmid = "0"
            NewComboFill(DDEmpName, "Select Distinct EI.EmpID,  EI.EmpName + ' / ' + EI.EmpCode EmpName " & _
        " From HomeFurnishingOrderMaster a(Nolock)  " & _
        " JOIN Employee_HomeFurnishingOrderMaster EMP(Nolock) ON EMP.IssueOrderID = a.ISSUEORDERID  " & _
        " JOIN Empinfo EI(Nolock) ON EI.EmpID = EMP.EmpID  " & _
        " Where a.COMPANYID = " & DDcompany.SelectedValue & " And a.BranchID = " & DDBranchName.SelectedValue & " " & _ 
        " And a.PROCESSID = " & DDprocess.SelectedValue & " And a.MASTERCOMPANYID = " & VarMasterCompanyID & " " & _
        " Order By EmpName ")
        End If
    End Sub
    Private Sub DDDepartment_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles DDEmpName.SelectedIndexChanged
        hnprmid = "0"
        gvdetail.Rows.Clear()
        FillIssueNo()
    End Sub
    Protected Sub FillIssueNo()
        If DDcompany.SelectedIndex <> -1 And DDEmpName.SelectedIndex <> -1 And Varcombovalue <> 0 Then
            Dim str As String = ""
            str = "Select Distinct a.ISSUEORDERID, a.CHALLANNO " & _
            " From HomeFurnishingOrderMaster a(Nolock)  " & _
            " JOIN Employee_HomeFurnishingOrderMaster EMP(Nolock) ON EMP.IssueOrderID = a.ISSUEORDERID And EMP.EmpID = " & DDEmpName.SelectedValue & " " & _
            " Where a.COMPANYID = " & DDcompany.SelectedValue & " And a.BranchID = " & DDBranchName.SelectedValue & " And a.PROCESSID = " & DDprocess.SelectedValue & " " & _
            " And a.MASTERCOMPANYID = " & VarMasterCompanyID & " " & _
            " And a.STATUS = 'PENDING'  " & _
    ...
    Private Sub DDissueNo_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles DDissueNo.SelectedIndexChanged
        If DDcompany.SelectedIndex <> -1 And DDEmpName.SelectedIndex <> -1 And DDissueNo.SelectedIndex <> -1 And Varcombovalue <> 0 Then
            Dim str As String = " Select Distinct VF.CATEGORY_ID, VF.CATEGORY_NAME " & _
            " From HomeFurnishingConsumptionDetail HCD(Nolock)  " & _
            " JOIN V_FinishedItemDetail VF(Nolock) ON VF.ITEM_FINISHED_ID = HCD.IFINISHEDID  " & _
            " Where HCD.ISSUEORDERID = " & DDissueNo.SelectedValue & " And HCD.PROCESSID = " & DDprocess.SelectedValue & " And HCD.MasterCompanyId = " & VarMasterCompanyID & " "
    ...
    Private Sub ddCatagory_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles ddCatagory.SelectedIndexChanged
        If ddCatagory.SelectedIndex <> -1 And DDissueNo.SelectedIndex <> -1 And DDprocess.SelectedIndex <> -1 And Varcombovalue <> 0 Then
            ...
            " Where HCD.ISSUEORDERID = " & DDissueNo.SelectedValue & " And HCD.PROCESSID = " & DDprocess.SelectedValue & " And HCD.MasterCompanyId = " & VarMasterCompanyID & " " & _
    ...
    Private Sub dquality_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles DDQuality.SelectedIndexChanged
        If DDQuality.SelectedIndex <> -1 And Varcombovalue <> 0 Then
            ...
            NewComboFill(DDShadeColor, "Select Distinct VF.ShadeColorID, VF.ShadeColorName " & _
                    ...
                    " VF.ITEM_ID = " & dditemname.SelectedValue & "  And VF.QualityID = " & DDQuality.SelectedValue & "  " & _
                    " Where HCD.ISSUEORDERID = " & DDissueNo.SelectedValue & "  And HCD.PROCESSID = " & DDprocess.SelectedValue & "  And HCD.MasterCompanyId = " & VarMasterCompanyID & " Order By VF.ShadeColorName")
        End If
    End Sub
    ...
    Private Sub btnsave_Click(sender As System.Object, e As System.EventArgs) Handles btnsave.Click
        ...
        Try
            ...
            param(5).Value = DDEmpName.SelectedValue
