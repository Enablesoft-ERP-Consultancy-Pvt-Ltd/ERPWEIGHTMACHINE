...
Public Class frmHandspinningissue
    ...
    Private Sub DDProcessName_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles DDProcessName.SelectedIndexChanged
        If DDProcessName.SelectedIndex <> -1 And Varcombovalue <> 0 Then
            NewComboFill(DDPartyName, "Select EI.EmpId,EI.EmpName From EmpInfo EI inner join EmpProcess EP on EI.EmpId=EP.EmpId and EP.ProcessId=" & DDProcessName.SelectedValue & " Where EI.Blacklist = 0 order by EI.empname")
        End If
    End Sub
    ...
    Private Sub DDLotno_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles DDLotno.SelectedIndexChanged
        If DDItem.SelectedIndex <> -1 And DDQuality.SelectedIndex <> -1 And DDColorShade.SelectedIndex <> -1 And DDLotno.SelectedIndex <> -1 And Varcombovalue <> 0 Then
            ...
            ElseIf DDBinNo.Visible = True Then
    ...
    End Sub
    Private Sub FillBinNo(ByVal varfinishedid As Integer)
        If DDCompanyName.SelectedIndex <> -1 And DDgodown.SelectedIndex <> -1 And DDgodown.SelectedIndex <> -1 And DDLotno.SelectedIndex <> -1 And Varcombovalue <> 0 Then
            ...
            If DDBinNo.Items.Count > 0 Then
                ...
                DDBinNo_SelectedIndexChanged(DDBinNo, New EventArgs())
            End If
    ...
    Private Sub btnsave_Click(sender As System.Object, e As System.EventArgs) Handles btnsave.Click
        ...
        Try
            Dim arr As SqlParameter() = New SqlParameter(28) {}
            ...
            arr(27) = New SqlParameter("@BellWt", If(TxtBellWeight.Text = "", "0", TxtBellWeight.Text))
    ...
    Protected Sub Fillgrid()
        ...
        Dim str As String = "select Sm.ID,Sd.Detailid,dbo.F_getItemDescription(Sd.Ifinishedid,sd.iflagsize) as IItemdescription, " & _
                           ...
                           " From HANDSPINNINGISSUEMASTER Sm inner join HANDSPINNINGISSUEDETAIL SD on Sm.ID=SD.masterid Where Sm.id=" & hnid
        Dim ds As DataSet = SqlHelper.ExecuteDataset(Con, CommandType.Text, str)
    ...
    Private Sub btnpreview_Click(sender As System.Object, e As System.EventArgs) Handles btnpreview.Click
        Dim str As String = "select * from V_HANDSPINNINGISSUEREPORT where id=" & hnid & ""
        Dim ds As DataSet = SqlHelper.ExecuteDataset(Con, CommandType.Text, str)
        ...
        If ds.Tables(0).Rows.Count > 0 Then
            ...
            sReportName = (My.Application.Info.DirectoryPath & "\Reports\HandspinningIssue.rpt")
            dspath = (My.Application.Info.DirectoryPath & "\ReportSchema\HandspinningIssue.xsd")
    ...
    Private Sub DDRShadecolor_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles DDRShadecolor.SelectedIndexChanged
        If DDRitemName.SelectedIndex <> -1 And DDRquality.SelectedIndex <> -1 And DDProcessName.SelectedIndex <> -1 And DDPartyName.SelectedIndex <> -1 And DDRShadecolor.SelectedIndex <> -1 And Varcombovalue <> 0 Then
            txtrate.Text = Module1.GetHandSpinningRate(DDRitemName.SelectedValue, DDRquality.SelectedValue, DDProcessName.SelectedValue, DDPartyName.SelectedValue, TxtDate.Text, shadecolorid:=DDRShadecolor.SelectedValue).ToString()
            txtrecqty.Focus()
        End If
    End Sub
    ...
    Private Sub DDRquality_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles DDRquality.SelectedIndexChanged
        If DDRitemName.SelectedIndex <> -1 And DDRquality.SelectedIndex <> -1 And DDProcessName.SelectedIndex <> -1 And DDPartyName.SelectedValue And Varcombovalue <> 0 Then
            txtrate.Text = Module1.GetHandSpinningRate(DDRitemName.SelectedValue, DDRquality.SelectedValue, DDProcessName.SelectedValue, DDPartyName.SelectedValue, TxtDate.Text).ToString()
        End If
