...
Public Class FrmDepartmentRowReceive
    ...
    Private Sub FrmDepartmentRowIssue_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        Dim str As String = "select Distinct CI.CompanyId,Companyname from Companyinfo CI " & _
                    ...
                    " Where a.TYPEFLAG = 1 And a.MasterCompanyID = " & VarMasterCompanyID & "  " & _
    ...
    Private Sub DDprocess_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles DDprocess.SelectedIndexChanged
        If DDprocess.SelectedIndex <> -1 And Varcombovalue <> 0 Then
            ...
            NewComboFill(DDDepartment, " Select Distinct a.DepartmentId, D.DepartmentName  " & _
                    ...
                    " Where a.TYPEFLAG = 1 And a.COMPANYID = " & DDcompany.SelectedValue & " And a.BranchID = " & DDBranchName.SelectedValue & " And a.PROCESSID = " & DDprocess.SelectedValue & " And a.MasterCompanyID = " & VarMasterCompanyID & " " & _
    ...
    Protected Sub FillIssueNo()
        If DDcompany.SelectedIndex <> -1 And DDDepartment.SelectedIndex <> -1 And Varcombovalue <> 0 Then
            ...
            " Where a.TYPEFLAG = 1 And a.CompanyID = " & DDcompany.SelectedValue & " And a.BranchID = " & DDBranchName.SelectedValue & " And a.ProcessID = " & DDprocess.SelectedValue & " And " & _
    ...
    Private Sub DDissueNo_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles DDissueNo.SelectedIndexChanged
        If DDcompany.SelectedIndex <> -1 And DDDepartment.SelectedIndex <> -1 And DDissueNo.SelectedIndex <> -1 And Varcombovalue <> 0 Then
            ...
            " Where TypeFlag = 1 And TranType=0 And IssueOrderID=" & DDissueNo.SelectedValue & " And MasterCompanyId = " & VarMasterCompanyID & " " & _
    ...
    Private Sub DDChallanNo_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles DDChallanNo.SelectedIndexChanged
        If DDcompany.SelectedIndex <> -1 And DDDepartment.SelectedIndex <> -1 And DDissueNo.SelectedIndex <> -1 And DDChallanNo.SelectedIndex <> -1 And Varcombovalue <> 0 Then
            ...
            " Where a.TYPEFLAG = 1 And a.PRMID = " & DDChallanNo.SelectedValue & "" & _
    ...
    Private Sub DDShape_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles DDShape.SelectedIndexChanged
        If DDcompany.SelectedIndex <> -1 And ddCatagory.SelectedIndex <> -1 And DDissueNo.SelectedIndex <> -1 And dditemname.SelectedIndex <> -1 And DDShape.SelectedIndex <> -1 And Varcombovalue <> 0 Then
            ...
            Dim str As String = " Select Distinct VF.SizeID, VF.SizeFt " & _
                            ...
                            " Where a.TYPEFLAG = 1 And a.CompanyID = " & DDcompany.SelectedValue & " And a.PRMID = " & DDChallanNo.SelectedValue & " " & _
                            " Order By VF.SizeFt"
    ...
    Private Sub ddlshade_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles DDShadeColor.SelectedIndexChanged
        If dditemname.SelectedIndex <> -1 And DDQuality.SelectedIndex <> -1 And DDShadeColor.SelectedIndex <> -1 And Varcombovalue <> 0 Then
            ...
            Dim str As String = "Select Distinct b.LotNo, b.LotNo " & _
                " From DEPARTMENTRAWISSUEMASTER a(Nolock) " & _
                " JOIN DEPARTMENTRAWISSUETRAN b(Nolock) on b.PRMID = a.PRMID  " & _
                " Where a.TYPEFLAG = 1 And a.PRMID = " & DDChallanNo.SelectedValue & " And b.ITEM_FINISHED_ID = " & TxtFinishedID.Text & " " & _
    ...
    Private Sub DDTagNo_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles DDTagNo.SelectedIndexChanged
        If dditemname.SelectedIndex <> -1 And DDQuality.SelectedIndex <> -1 And DDShadeColor.SelectedIndex <> -1 And Varcombovalue <> 0 Then
            ...
            " From DEPARTMENTRAWISSUEMASTER a(Nolock) " & _
            " JOIN DEPARTMENTRAWISSUETRAN b(Nolock) on b.PRMID = a.PRMID  " & _
            " Where a.TranType = 0 And a.TypeFlag = 1 And a.PRMID = " & DDChallanNo.SelectedValue & " And b.ITEM_FINISHED_ID = " & TxtFinishedID.Text & " " & _
            " And b.LotNo = '" & DDLotno.Text & "' And b.TAGNO = '" & DDTagNo.Text & "'" & _
            " Select IsNull(Sum(b.Qty), 0) RecQty  " & _
            " From DEPARTMENTRAWISSUEMASTER a(Nolock) " & _
            " JOIN DEPARTMENTRAWISSUETRAN b(Nolock) ON b.PRMID = a.PRMID  " & _
            " Where a.TranType = 1 And a.TypeFlag = 1 And a.IssuePRMID = " & DDChallanNo.SelectedValue & " And b.ITEM_FINISHED_ID = " & TxtFinishedID.Text & " " & _
            " And b.LotNo = '" & DDLotno.Text & "' And b.TAGNO = '" & DDTagNo.Text & "'"
            Dim ds As DataSet = SqlHelper.ExecuteDataset(Con, CommandType.Text, str)

            txtissueqty.Text = ds.Tables(0).Rows(0)("IssQty")
            TxtPendingQty.Text = ds.Tables(0).Rows(0)("IssQty") - ds.Tables(1).Rows(0)("RecQty")
    ...
    Private Sub btnsave_Click(sender As System.Object, e As System.EventArgs) Handles btnsave.Click
        ...
        Try
            ...
            param(25).Value = DDChallanNo.SelectedValue
    ...
    Protected Sub PrintBarcode()
        Dim str As String
        str = "Select Top 1 b.PRTID BarCode, PIDM.IssueNo + ' / ' + a.CHALLANNO IssueChallanNo, " & _
            " VF.QualityName, VF.ShadeColorName, PIDM.IssueNo FolioNo, REPLACE(CONVERT(NVARCHAR(11), a.Date, 106), ' ', '-') RecDate, b.LOTNO, b.TAGNO, b.QTY, b.BINNO " & _
            " From DEPARTMENTRAWISSUEMASTER a(Nolock)  " & _
            " JOIN DEPARTMENTRAWISSUETRAN b(Nolock) on b.PRMID = a.PRMID  " & _
            " JOIN ProcessIssueToDepartmentMaster PIDM(Nolock) on PIDM.IssueOrderID = a.ISSUEORDERID  " & _
            " JOIN V_FinishedItemDetail VF(Nolock) ON VF.ITEM_FINISHED_ID = b.ITEM_FINISHED_ID  " & _
            " Where a.PRMID = " & hnprmid & " order by b.PRTID Desc"
        ...
        If ds.Tables(0).Rows.Count > 0 Then
            ...
            If (VarMasterCompanyID = 16) Then
                TempFileTextLine = String.Format(prn, "" & ds.Tables(0).Rows(0)("BarCode") & "", "" & ds.Tables(0).Rows(0)("IssueChallanNo") & "","" & ds.Tables(0).Rows(0)("QualityName") & "", "" & ds.Tables(0).Rows(0)("ShadeColorName") & "","" & ds.Tables(0).Rows(0)("FolioNo") & "", "" & ds.Tables(0).Rows(0)("RecDate") & "","" & ds.Tables(0).Rows(0)("LOTNO") & "", "" & ds.Tables(0).Rows(0)("TAGNO") & "","" & ds.Tables(0).Rows(0)("QTY") & "", "" & ds.Tables(0).Rows(0)("BINNO") & "")
            End If
